CREATE VIEW v_full_dashboard AS (
SELECT A.id, A.game_name as GameName, P.id as PlayerID, P.user_name as PlayerName, coalesce(D.kills, 0)  as Kills, coalesce(C.deaths,0) as Deaths
FROM game A 
